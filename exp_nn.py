...
args = argparse.Namespace(desc='exp_nn', dataset='', preprocessing='default',
                          validation_ratio=0.2, expansion=0, no_shuffle=False,
                          n_workers_dl=1, features_net=None,
                          algorithm='nn', model='NN2',
                          activation='relu', bound=0,
                          module_size=1000, n_modules=1,
...
for args.dataset in bsizes.keys():
    ...
    # default module_size, loss for classification & large datasets
    args.module_size = 10000
